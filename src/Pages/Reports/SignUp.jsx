...
import background from "/home/eslam/Elmo/CS4/project/Biometric-Authentication/src/assets/BG.jpg"
...
export default function SignUp() {
    return (
        ...
        h-screen bg-fixed bg-cover bg-center bg-no-repeat"
            style={{
...
function Sign_up() {
    ...
    var name = document.getElementById("name").value;    var password = document.getElementById("password").value;
